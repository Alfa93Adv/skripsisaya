    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="<?php echo base_url('barang.php')?>">
          ...
          <tbody>
            ...
            foreach ($user as $key) 
            {
             ...
             <tr>
              ...
              <td>
                <a href="<?= base_url() ?>user/hapusUser/<?= $key->id_user?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus Data : <?=$key->username;?> ?');"><i class="fa fa-trash"></i></span></a>
                <a href="<?= base_url() ?>Users/edit_user/<?= $key->id_user?>" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span></a>
              </td>
            </tr>
            <?php
            $i++;
